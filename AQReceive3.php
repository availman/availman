...
$xml = new SimpleXMLElement("./AQEvent3.xml",0,true); 
$xml_admin = new SimpleXMLElement("./AQ_SET3.xml",0,true); 
...
$now_time = date("H:i:s");
	...
	if($today != $now_date)
	{
    	...
    	$newfile0 = fopen("./AQEvent3.xml","w") or die("Unable to open file!");
    	...
    	$checking_info .= '</GroupSet>'.chr(10);
    	$chk_file = fopen("./AQ_SET3.xml","w") or die("Unable to open file!");
