...
$name0 = $_GET["waitinfo"];
//print $name2;
$myfile = fopen("./newfile1.xml","w") or die("Unable to open file!");
fwrite($myfile,$name0);
fclose($myfile);	
...
$xml = new SimpleXMLElement("./AQEvent1.xml",0,true); 
$xml_admin = new SimpleXMLElement("./AQ_SET1.xml",0,true); 
...
$now_time = date("H:i:s");
	...
	if($today != $now_date)
	{
    	...
    	$newfile0 = fopen("./AQEvent1.xml","w") or die("Unable to open file!");
    	...
    	$checking_info .= '</GroupSet>'.chr(10);
    	$chk_file = fopen("./AQ_SET1.xml","w") or die("Unable to open file!");
